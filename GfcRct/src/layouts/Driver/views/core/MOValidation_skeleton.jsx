...
const data = [
    {
        header: "<h1 className='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white'>Embrace the <mark class='animate-pulse px-2 text-white bg-red-600 rounded dark:bg-red-500'>Chaos of Food</mark> at the hottest time</h1>",
        paragraph:
            "<p className='text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400'>Here at GFC, we specialize in delivering food with a touch of dark humor. We understand the trials and tribulations of waiting for your meal, especially when you're part of the delivery team. But fear not, for our unique brand of comedy will keep you entertained as you wait for your next order to come in.</p>",
    },
    {
        header: "<h1 class='mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl'><span class='text-transparent bg-clip-text bg-gradient-to-r to-red-400 animate-pulse from-red-800'>Survive the Gauntlet</span> of Hungry Customers.</h1>",
        paragraph:
            "<p class='text-lg font-normal text-gray-500 lg:text-xl dark:text-gray-400'>Welcome to our food delivery service, where we test your endurance against the most ravenous appetites. Brace yourself for the chaotic frenzy of orders and the never-ending hunger of our customers. It's a battle out there, but with a sprinkle of dark humor, you'll come out victorious!</p>"
    },
    {
        header: "<h1 class='mb-4 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white'>Enter the <span class='underline underline-offset-3 decoration-8 animate-pulse decoration-red-400 dark:decoration-red-600'>Twilight Zone</span> of Food Delivery</h1>",
        paragraph:

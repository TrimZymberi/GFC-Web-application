...
export default function QuickAdd() {
    return (
        <div className='grid sm:grid-cols-1 md:grid-cols-4 gap-4'>
            <div className='col-span-1' style={{height: '50px'}}>
            ...
            <div className='col-span-1 ' style={{height: '50px'}}>
                <div className='p-6 px-3 h-25 bg-blue-500 shadow-sm flex justify-between items-center rounded'>
                    <div>
            ...
            <div className='col-span-1 ' style={{height: '50px'}}>
                <div className='p-6 px-3 h-25 bg-yellow-300 shadow-sm flex justify-between items-center rounded'>
                    <div>
            ...
            <div className='col-span-1 ' style={{height: '50px'}}>
                <div className='p-6 px-3 h-25 bg-red-500 shadow-sm flex justify-between items-center rounded'>
                    <div>

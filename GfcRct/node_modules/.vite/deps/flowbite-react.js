...
var AccordionComponent = ({ alwaysOpen = false, arrowIcon = HiChevronDown, children, flush = false, collapseAll = false, className, theme: customTheme = {}, ...props }) => {
  ...
  const panels = (0, import_react4.useMemo)(() => import_react4.Children.map(children, (child, i2) => (0, import_react4.cloneElement)(child, {
    alwaysOpen,
    arrowIcon,
    flush,
    isOpen: isOpen === i2,
...
// ../node_modules/flowbite-react/lib/esm/components/Button/Button.js
var ButtonComponent = (0, import_react8.forwardRef)(({ children, className, color = "info", disabled = false, fullSized, isProcessing = false, processingLabel = "Loading...", processingSpinner: SpinnerComponent = (0, import_jsx_runtime16.jsx)(Spinner, {}), gradientDuoTone, gradientMonochrome, href, label, outline = false, pill = false, positionInGroup = "none", size: size2 = "md", theme: customTheme = {}, ...props }, ref) => {
...
var DropdownComponent = ({ children, className, dismissOnClick = true, theme: customTheme = {}, ...props }) => {
  ...
  const content = (0, import_react18.useMemo)(() => (0, import_jsx_runtime25.jsx)("ul", { className: theme2.content, children: import_react18.Children.map(children, attachCloseListener) }), [attachCloseListener, children, theme2.content]);
...
var TabsComponent = (0, import_react35.forwardRef)(({ children, className, onActiveTabChange, style = "default", theme: customTheme = {}, ...props }, ref) => {
  ...
  const [focusedTab, setFocusedTab] = (0, import_react35.useState)(-1);
